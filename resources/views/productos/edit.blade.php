        ...
        <div class="row">
          <div class="col-8 mb-3">
            ...
            <input id="nombre" class="form-control" type="text" name="nombre"
                   placeholder="Ej. Detector inductivo" value="{{ old('nombre', $producto->nombre) }}">
          </div>
          ...
          <div class="col-4 mb-3">
            ...
            <select name="moneda_id" class="form-select">
              <option value="1" {{ old('moneda_id', $producto->moneda_id) == '1' ? 'selected' : '' }}>
                (S/.)Soles</option>
              <option value="2" {{ old('moneda_id', $producto->moneda_id) == '2' ? 'selected' : '' }}>
                ($/.)Dólares</option>
            </select>
          </div>
          ...
          <div class="col-3 mb-3">
            ...
            <input id="valor_venta" class="form-control" type="number" name="valor_venta" step="0.001"
                   ...
                   value="{{ old('valor_venta', $producto->valor_venta) }}">
          </div>
          <div class="col-3 mb-3">
              ...
              @foreach ($tiposIgv as $tipo)
                @if ($tipo->activo == '1')
                  <option value="{{ $tipo->id }}"
                          ...
                          {{ old('tipo_igv_id', $producto->tipo_igv_id) == $tipo->id ? 'selected' : '' }}>
          ...
          <div class="col-sm-12 mb-3">
            <label for="imagen" class="form-label d-block">Cambiar Imagen</label>
            <img width="200px"
